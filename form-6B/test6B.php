...
//   $selectshort = $_POST["selectshort"];
  ...
  $atr3selectrisk = $_POST["atr3selectrisk"];
    ...
    //Textbox2
    $entprice = round(($texbox2 + $entval) * 10000) / 10000;
    $validaprice = round(($texbox2 + $texbox1) * 10000) / 10000;
    $retestprice = round(($texbox2 + $tval3) * 10000) / 10000;
    $atr1shortentryprice = round(($texbox2 + $atr1entryval1) * 10000) / 10000;
    $atr1shortstopprice = round(($texbox2 + $atr1entryval2) * 10000) / 10000;
    $atr1shortexitprice = round(($texbox2 + $atr1entryval3) * 10000) / 10000;

    $atr2shortentryprice = round(($texbox2 + $atr2entryval1) * 10000) / 10000;
    $atr2shortstopprice = round(($texbox2 + $atr2entryval2) * 10000) / 10000;
    $atr2shortexitprice = round(($texbox2 + $atr2entryval3) * 10000) / 10000;

    $atr3shortentryprice = round(($texbox2 + $atr3entryval1) * 10000) / 10000;
    $atr3shortstopprice = round(($texbox2 + $atr3entryval2) * 10000) / 10000;
    $atr3shortexitprice = round(($texbox2 + $atr3entryval3) * 10000) / 10000;
    ...
    //TextBox3
    $stopprice = round(($texbox3 - $entval) * 10000) / 10000;
    $invalidprice = round(($texbox3 - $texbox1) * 10000) / 10000;
    $rightentryprice = round(($texbox3 - $entval) * 10000) / 10000;
    $rightstoporderprice = round(($texbox2 + $entval) * 10000) / 10000;
    $rightvalidprice = $invalidprice;
    $rightretest = round(($texbox3 - $tval3) * 10000) / 10000;
    $rightinvalid = round(($texbox2 + $texbox1) * 10000) / 10000;
    $rightatr1entryprice = round(($texbox3 - $atr1entryval1) * 10000) / 10000;
    $rightatr1stoporderprice = round(($texbox3 - $atr1entryval2) * 10000) / 10000;
    $rightart1existprice = round(($texbox3 - $atr1entryval3) * 10000) / 10000;

    $rightatr2entryprice = round(($texbox3 - $atr2entryval1) * 10000) / 10000;
    $rightatr2stoporderprice = round(($texbox3 - $atr2entryval2) * 10000) / 10000;
    $rightart2existprice = round(($texbox3 - $atr2entryval3) * 10000) / 10000;

    $rightatr3entryprice = round(($texbox3 - $atr3entryval1) * 10000) / 10000;
    $rightatr3stoporderprice = round(($texbox3 - $atr3entryval2) * 10000) / 10000;
    $rightart3existprice = round(($texbox3 - $atr3entryval3) * 10000) / 10000;
    ...
    if ($selectrisk == "riskpoint") {
        ...
        $riskpoints = ($entprice - $stopprice) / 0.0001;
    }
    ...
    if ($riskpoints != 0) { // Check for division by zero
        if ($selectrisk == "riskpoint") {
            $nqcontracts = ($riskval / $riskpoints) / 625000;
        } elseif ($selectrisk == "riskticks") {
            $nqcontracts = (($riskval / $riskpoints) / 625000) / 0.0001;
        }
    }  
    ...
    if ($atr1selectrisk == "riskpoint") {
        ...
        if ($atr1riskpoints != 0) {
            $atr1escontracts = ($riskval2 / $atr1riskpoints) / 625000;
        } else {
        ...
        $atr1riskpoints = ($atr1shortstopprice - $atr1shortentryprice)/ 0.0001;
        if ($atr1riskpoints != 0) {
            $atr1escontracts = (($riskval2 / $atr1riskpoints) / 625000 ) / 0.0001;
        } 
    }
    ...
    if ($atr2selectrisk == "riskpoint") {
        ...
        if ($atr2riskpoints != 0) {
            $atr2escontracts = ($riskval2 / $atr2riskpoints) / 625000;
        }
    } elseif ($atr2selectrisk == "riskticks") {
        $atr2riskpoints = ($atr2shortstopprice - $atr2shortentryprice) / 0.0001;
        if ($atr2riskpoints != 0) {
            $atr2escontracts = (($riskval2 / $atr2riskpoints) / 625000 ) / 0.0001;
        }
    }
    ...
    if ($atr3selectrisk == "riskpoint") {
        ...
        if ($atr3riskpoints != 0) {
            $atr3escontracts = ($riskval2 / $atr3riskpoints) / 625000;
        }
    } elseif ($atr3selectrisk == "riskticks") {
        $atr3riskpoints = ($atr3shortstopprice - $atr3shortentryprice) / 0.0001;
        if ($atr3riskpoints != 0) {
            $atr3escontracts = (($riskval2 / $atr3riskpoints) / 625000 ) / 0.0001;
        }
    }
