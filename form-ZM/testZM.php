...
function textBox3($data,$result1)
{
    ...
    $entprice = 0;
    if($texbox3 > 0) {
         $entprice = round(($texbox3 - $entval) * 10) / 10;
    } 
    $stopprice = $entprice;
    ...
    $rightretest = round(($texbox3 - $retest) * 10) / 10;
...
function callRisk($data,$result2,$result3) {
    ...
    $result['riskpoints'] = number_format($riskpoints, 1);
    return $result;
...
function Contracts($data,$result4,$result5) {
    ...
    $result['nqcontracts'] = number_format($nqcontracts, 1);
...
function atr1SelectCal($data,$result2,$result6)
{
    ...
    $result['atr1riskpoints'] = number_format($atr1riskpoints, 1);
    $result['atr1escontracts'] = number_format($atr1escontracts, 1);
...
function atr2SelectCal($data,$result2,$result6)
{
    ...
    $result['atr2riskpoints'] = number_format($atr2riskpoints, 1);
    $result['atr2escontracts'] = number_format($atr2escontracts, 1);
...
function atr3SelectCal($data,$result2,$result6)
{
    ...
    $result['atr3riskpoints'] = number_format($atr3riskpoints, 1);
    $result['atr3escontracts'] = number_format($atr3escontracts, 1);
