jQuery(document).ready(function ($) {
  ...
  $(
    ".textbox1, .textbox2, .textbox3, .acctsize, .maxloss, .acctsize2, .maxloss2"
  ...
  function calculateData() {
    var data = {
      ...
      // entval: $(".entryval").text(),
      // atr1entryval1: $(".atr1entryval1").text(),
      // atr1entryval2: $(".atr1entryval2").text(),
      // atr1entryval3: $(".atr1entryval3").text(),

      // atr2entryval1: $(".atr2entryval1").text(),
      // atr2entryval2: $(".atr2entryval2").text(),
      // atr2entryval3: $(".atr2entryval3").text(),

      // atr3entryval1: $(".atr3entryval1").text(),
      // atr3entryval2: $(".atr3entryval2").text(),
      // atr3entryval3: $(".atr3entryval3").text(),

      // retest: $(".retest").text(),
      // stopprice: $(".stopprice").text(),
      // riskval: $(".riskval").text(),
      // riskpoints: $(".riskpoints").text(),

      // entprice: $(".entryprice").text(),
      // rightentryprice: $(".rightentryprice").text(),
      // riskval2: $(".riskval2").text(),

      // atr1shortstopprice: $(".atr1shortstopprice").text(),
      // atr1shortentryprice: $(".atr1shortentryprice").text(),
      // atr1shortexitprice: $(".atr1shortexitprice").text(),
      // atr1riskpoints: $(".atr1riskpoints").text(),

      // atr2shortstopprice: $(".atr2shortstopprice").text(),
      // atr2shortentryprice: $(".atr2shortentryprice").text(),
      // atr2shortexitprice: $(".atr2shortexitprice").text(),

      // atr3shortstopprice: $(".atr3shortstopprice").text(),
      // atr3shortentryprice: $(".atr3shortentryprice").text(),
      // atr3shortexitprice: $(".atr3shortexitprice").text(),
    };

    $.ajax({
      type: "POST",
      url: "http://localhost/atr/api/Form-RTY/testRTY.php",
      data: data,
      dataType: "json",
