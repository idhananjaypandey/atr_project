...
if ($riskpoints != 0) { // Check for division by zero
    $nqcontracts = ($riskval / number_format($riskpoints, 3)) / 500;
}
...
if ($atr1riskpoints != 0) { // Check for division by zero
    $atr1escontracts = ($riskval2 / $atr1riskpoints) / 500;
}
...
if ($atr2riskpoints != 0) { // Check for division by zero
    $atr2escontracts = ($riskval2 / number_format($atr2riskpoints, 3)) / 500;
}
...
if ($atr3riskpoints != 0) { // Check for division by zero
    $atr3escontracts = ($riskval2 / number_format($atr3riskpoints, 2)) / 500;
}
