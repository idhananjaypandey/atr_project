  ...
  $atr3selectrisk = $_POST["atr3selectrisk"];
    ...
    if ($riskpoints != 0) { // Check for division by zero
        if ($selectrisk == "riskpoint") {
            ...
            $nqcontracts = (($riskval / $riskpoints) / 50) / 0.1;
        }
    }
    ...
    if ($atr1selectrisk == "riskpoint") {
        ...
        if ($atr1riskpoints != 0) {
            $atr1escontracts = (($riskval2 / $atr1riskpoints) / 50 ) / 0.1;
    ...
    if ($atr2selectrisk == "riskpoint") {
        ...
        if ($atr2riskpoints != 0) {
            $atr2escontracts = (($riskval2 / $atr2riskpoints) / 50 ) / 0.1;
    ...
    if ($atr3selectrisk == "riskpoint") {
        ...
        if ($atr3riskpoints != 0) {
            $atr3escontracts = (($riskval2 / $atr3riskpoints) / 50 ) / 0.1;
